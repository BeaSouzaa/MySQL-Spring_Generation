...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal || BeaSouza").description("Projeto API Spring - Blog Pessoal || BeaSouza")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/BeaSouza")
				.contact(contact()).build();

	}

	private static Contact contact() {
		return new Contact("Beatriz Souza", "https://github.com/BeaSouzaa", "beatrizgsouza.bgs@gmail.com");
